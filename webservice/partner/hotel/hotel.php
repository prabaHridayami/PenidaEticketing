...
if (isset($_POST['submit'])) {
  ...
  if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
    if (move_uploaded_file($file_tmp, 'image/' . $nama) || $ukuran < 844070) {
      $inserting_data = mysqli_query($conn, "INSERT INTO tb_hotel VALUES ('', '$id_user','$name','$address','$phone','$check_out','$check_in','$nama','1')");
      if ($inserting_data) {
        // echo "Sukses";
        echo "<script type='text/javascript'>alert('Data Succes');window.location.href='hotel.php';</script>";
      } else {
        // echo "Gagal";
        echo "<script type='text/javascript'>alert('Data Failed');window.location.href='hotel.php';</script>";
      }
    } else {
      // echo "Kurang";
      echo "<script type='text/javascript'>alert('Data Kurang');window.location.href='hotel.php';</script>";
    }
  } else {
    echo "<script type='text/javascript'>alert('Hotel Failed');window.location.href='hotel.php';</script>";
  }
}
?>
<!DOCTYPE html>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Request Hotel</h5>
                  ...
                  <div class="modal-body">
                    <div class="row">
                      <div class="col-6">
                        ...
                        <input class="form-control" type="text" name="name" id="" placeholder="Hotel Name">
                      </div>
                      <div class="col-6">
                    ...
                    <div class="row">
                      <div class="col-6">
                        ...
                        <input class="form-control" type="time" name="check_in" id="" placeholder="Check In Time">
                      </div>
                      <div class="col-6">
                        <label for="">Check Out Time</label>
                        <input class="form-control" type="time" name="check_out" id="" placeholder="Check Out Time">
                      </div>
                    </div>
                    <div class="">
          ...
          <div class="row">
            <?php
            $selecthotel = mysqli_query($conn, "SELECT * FROM tb_hotel WHERE id_user = $id_user AND status = '2'");
              ...
              while ($fetch = mysqli_fetch_assoc($selecthotel)) { ?>
                <div class="col-lg-3 col-6">
                  <div class="small-box bg-info">
                    ...
                    <a href="gethotel.php?id=<?php echo $fetch['id'] ?>" class="small-box-footer">Add Room <i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
              <?php
              } ?>
