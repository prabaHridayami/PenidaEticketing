  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          <?php
          $result = mysqli_query($conn, "SELECT tb_trans_hotel.`id`,tb_trans_hotel.`proof`, tb_trans_hotel.status, tb_hotel.`name` AS 'Nama Hotel', tb_room.`name` AS 'Nama Kamar',tb_user.`name` AS 'Nama User',tb_trans_hotel.`check_in`,tb_trans_hotel.`check_out`,tb_trans_hotel.`reserve_date`,tb_trans_hotel.`total_price`,tb_trans_hotel.`id`FROM tb_trans_hotel JOIN tb_room ON tb_trans_hotel.id_room = tb_room.id JOIN tb_category_room ON tb_category_room.`id` = tb_room.`id_category`JOIN tb_hotel ON tb_hotel.`id` = tb_category_room.`id_hotel`JOIN tb_user ON tb_trans_hotel.id_user = tb_user.id WHERE tb_hotel.`id_user` = '$id_user' ORDER BY id DESC");
          ?>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><a href="#" class="pop"><img style="border-radius:8px;" src="../../admin/hotel/transaksi/<?php echo $row['proof']; ?>" width="50" height="50"></a></td>
                    <td>
