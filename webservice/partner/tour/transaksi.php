              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><a href="#" class="pop"><img style="border-radius:8px;" src="../../admin/tour/transaksi/<?php echo $row['proof']; ?>" width="50" height="50"></a></td>
                    <td>
