    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Dashboard Transaksi Boat</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../partner/">Home</a></li>
                <li class="breadcrumb-item active">Transaksi Boat</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <?php if ($row['status'] == 'prossed') {
                      ?>
                        <input type="checkbox" class="checkbox" name="checkbox" id="checkbox" value="<?php echo $row['id']; ?>" data-toggle="toggle" data-off="Disabled" data-on="Enabled">
                      <?php
                      } ?>
                      <?php if ($row['status'] == 'success') {
                      ?>
                        <input type="checkbox" class="checkbox" name="checkbox" id="checkbox" value="<?php echo $row['id']; ?>" data-toggle="toggle" data-off="Disabled" data-on="Enabled" checked>
                      <?php
                      } ?>
                    </td>
                    <td><a href="#" class="pop"><img style="border-radius:8px;" src="../../admin/boat/transaksi/<?php echo $row['proof']; ?>" width="50" height="50"></a></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
