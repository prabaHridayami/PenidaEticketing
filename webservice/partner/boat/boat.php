    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Request Boat</h5>
                  ...
                  <div class="modal-body">
                    <div class="row">
                      <div class="col-6">
                        ...
                        <input class="form-control" type="text" name="name" id="" placeholder="Boat Name">
                      </div>
                      <div class="col-6">
          ...
          <div class="row">
            <?php
            $selecthotel = mysqli_query($conn, "SELECT * FROM tb_boat WHERE id_user = $id_user AND status = '2'");
              ...
              while ($fetch = mysqli_fetch_assoc($selecthotel)) { ?>
                <div class="col-lg-3 col-6">
                  <div class="small-box bg-warning">
                    ...
                    <a href="getboat.php?id=<?php echo $fetch['id'] ?>" class="small-box-footer">Add Boat <i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
              <?php
              } ?>
