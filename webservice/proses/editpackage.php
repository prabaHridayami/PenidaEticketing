...
$id_boat = $_GET['id'];
$flag = $_GET['flag'];
$modal = mysqli_query($conn, "SELECT * FROM tb_temple WHERE id = '$flag'");
$r = mysqli_fetch_array($modal);
?>
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="myModalLabel">Edit Temple Tour</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <form action="getpackage.php?id=<?php echo $id_boat ?>" name="modal_popup" enctype="multipart/form-data" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <input class="form-control" type="text" name="location" id="" value="<?php echo $r['location']; ?>" required="true">
                        </div>
                    </div>
                    <div class="mb-3">
