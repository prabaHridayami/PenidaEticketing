...
$id_boat = $_GET['id'];
$flag = $_GET['flag'];
$modal = mysqli_query($conn, "SELECT * FROM tb_det_boat WHERE id = '$flag'");
...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <form action="getboat.php?id=<?php echo $id_boat ?>" name="modal_popup" enctype="multipart/form-data" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input class="form-control" type="text" name="kuota" id="" value="<?php echo $r['quota']; ?>" required="true">
                        </div>
                        <div class="col-6">
