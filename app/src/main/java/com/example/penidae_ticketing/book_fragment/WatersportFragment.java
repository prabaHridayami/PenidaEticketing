...
public class WatersportFragment extends Fragment implements BookView, TransWatersportAdapter.OnClickListener {

    View v;
    private RecyclerView recyclerView;
    List<TransWatersportItem> transWatersportItems;
    private TransWatersportAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fragment_watersport,container,false);

        recyclerView = v.findViewById(R.id.rv_watersport);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        bookPresenter.getTransWatersport(id_user);
    }
    ...
    @Override
    public void onSuccessWatersport(List<TransWatersportItem> transWatersportItems) {
        this.transWatersportItems = transWatersportItems;
        adapter=new TransWatersportAdapter(getContext(),transWatersportItems);
